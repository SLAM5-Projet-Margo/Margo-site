...
class M_DaoPersonne extends M_DaoGenerique {
    ...
    public function enregistrementVersObjet($enreg) {
        // on instancie les objets Role s'il y a lieu
        $leRole = null;
        ...
        $retour = new M_Personne(
                $enreg['IDPERSONNE'], $leRole, $enreg['CIVILITE'], $enreg['NOM'], $enreg['PRENOM'], $enreg['NUM_TEL'], $enreg['ADRESSE_MAIL'], $enreg['NUM_TEL_MOBILE'], $enreg['LOGINUTILISATEUR'], $enreg['MDPUTILISATEUR']
        );
        return $retour;
    }
    ...
    function insert($objetMetier) {
        ...
        try {
            ...
            $sql .= "LOGINUTILISATEUR,MDPUTILISATEUR)  ";
            $sql .= "VALUES (";
